...
Located relative to the script:
- `commands_data.yaml` - Deprecated compatibility data for commands
- `.claude/skills/an-help/scripts/skills_data.yaml` - Canonical source data for skills
- `.claude/scripts/skills_data.yaml` - Legacy pointer to the canonical skills data
