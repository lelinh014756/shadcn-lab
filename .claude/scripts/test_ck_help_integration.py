#!/usr/bin/env python3
"""Integration tests for canonical an-help query routing."""
...
def marker(output: str) -> str:
    for line in output.splitlines():
        if line.startswith("@AN_OUTPUT_TYPE:"):
            return line.replace("@AN_OUTPUT_TYPE:", "", 1).strip()
    return ""
...
def main() -> int:
    ...
    print("=" * 60)
    print("an-help integration tests")
    print("=" * 60)
