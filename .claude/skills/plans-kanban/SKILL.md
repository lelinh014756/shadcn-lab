...
```bash
# Option 1: Install via AgentNet CLI (recommended)
...
Use `/an-kanban` for quick access:
...
| Route                   | Description                      |
| ----------------------- | -------------------------------- |
| `/` or `/an-kanban`     | Dashboard view                   |
| `/an-kanban?dir=<path>` | Dashboard for specific directory |
