...
- Otherwise use `an:repomix` to generate fresh codebase summary
- Use `/an-scout` or `/an-scout ext` to find relevant files
- Use `an:docs-seeker` skill for package/plugin documentation
