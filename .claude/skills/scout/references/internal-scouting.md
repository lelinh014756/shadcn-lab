...
CRITICAL: Skip build/output folders - NEVER scan bin/, obj/, node_modules/, dist/, etc.

Instructions:
- Search for relevant files matching the task
- Use Glob/Grep with ignore patterns for build folders
- Filter results BEFORE reading content
