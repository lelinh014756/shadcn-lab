...
When generating mermaid code blocks, use `/an:mermaidjs-v11` skill for v11 syntax rules.
...
For `--slides`: recommend invoking `/an:ui-ux-pro-max` for richer style selection.
Must use `/an:mermaidjs-v11` for any Mermaid diagrams.
