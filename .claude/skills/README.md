...
## Meta Skills
- **skill-creator** - Guide for creating effective skills that extend Claude's capabilities (use its references as a starting layout for new skills)
...
Skills are simple to create - just a folder with a `SKILL.md` file containing YAML frontmatter and instructions. Use **skill-creator** in this repository as the starting point for structure and conventions:
