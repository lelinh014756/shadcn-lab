 ...
 */
import { getBrowser, getPage, closeBrowser, disconnectBrowser, healthCheckPage, ensurePageReady, parseArgs, outputJSON, outputError } from './lib/browser.js';
...
async function selectRef() {
  ...
  try {
    ...
    await ensurePageReady(page, {
      action: 'interact with aria snapshot refs',
    });
