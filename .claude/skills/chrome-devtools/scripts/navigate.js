 ...
 */
import { getBrowser, getPage, closeBrowser, disconnectBrowser, saveAuthSession, rememberPageSelection, healthCheckPage, parseArgs, outputJSON, outputError } from './lib/browser.js';
...
async function navigate() {
  ...
  try {
    ...
    const pageSelection = await rememberPageSelection(page, {
      reason: 'navigate',
      intentUrl: args.url,
    });
    const pageHealth = await healthCheckPage(page, {
