...
### 1. Regression Test (ALWAYS required in strongest practical form)

Every fix MUST have regression evidence.
- **P0/P1 / critical / prod-staging / core logic:** red-green proof is mandatory.
- Other fixes: add the strongest practical regression evidence available, with red-green strongly recommended.

Target behavior for a full regression test:
...
Apply layered validation from `an:debug` defense-in-depth technique:
...
Canonical verification gate: `../../an-verify/references/verification-gate.md`
Regression severity policy: `../../an-verify/references/regression-red-green.md`
...
□ Severity checked? (P0/P1 => red-green mandatory; if unclear, ask first)
